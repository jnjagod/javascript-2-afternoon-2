...
function removeItem(myGroceryList, item){
  let empty = []
  if(!item || !myGroceryList){return empty}
...
delet(devMountainEmployees, 'Cahlan')
console.log(devMountainEmployees.length)
...
deleted(users, 'mark.mciver@devmounta.in')
